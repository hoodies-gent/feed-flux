...
SYSTEM_PROMPT = (
    ...
    "explicitly asks to inspect memory; it pauses for user approval. Use its cursor only when the "
    "user asks for another page. update_memory changes only a selected memory's value. "
